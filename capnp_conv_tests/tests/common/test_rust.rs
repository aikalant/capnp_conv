...
use crate::test_capnp::{self, basic_struct, comprehensive_struct, generic_struct};
...
pub struct ComprehensiveStruct<T, Y> {
    ...
    pub enum_val: test_capnp::ComprehensiveStructEnum,
...
#[capnp_conv(test_capnp::ComprehensiveStructEnum)]
...
pub enum ComprehensiveUnion<T, Y> {
    ...
    #[capnp_conv(type = "enum")]
    EnumVal(test_capnp::ComprehensiveStructEnum),
    #[capnp_conv(type = "enum_remote")]
